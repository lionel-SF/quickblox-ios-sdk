...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if ([[self storedMessages] count] > 0 && self.dataSource.totalMessagesCount == 0) {
        ...
        if (self.dataSource.totalMessagesCount == 0) [SVProgressHUD showWithStatus:NSLocalizedString(@"SA_STR_LOADING_MESSAGES", nil) maskType:SVProgressHUDMaskTypeClear];
